...
-->
            <div class="ui two item menu">
                <a href="delivered.php" class="item">Delivered</a>
                <a class="item active">Pending Orders</a>
            </div>
                    ...
                    <tbody>
                        ...
                        while ($cart_row = mysql_fetch_array($cart_table)) 
                        {
                            ...
                            <tr>   
								...
								<td width="140"><a href="update_status.php<?php echo '?id='.$order_id; ?>" class="btn btn-success">
                                    <i class="fa fa-check"></i>&nbsp;Confirm Order</a>
                                </td>			
                            </tr>
                            <?php } ?>
                        </tbody>
