...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="admin/css/semantic.css">
        <link rel="stylesheet" type="text/css" href="admin/css/jquery.navgoco.css">
    ...
    <script src="admin/js/jquery.navgoco.js" type="text/javascript"></script>
    <script src="admin/js/highlight.pack.js" type="text/javascript"></script>
    <script src="admin/js/demo.js" type="text/javascript"></script>
    ...
    <link rel="stylesheet" href="admin/css/nivo-slider1.css" type="text/css" media="screen" /> 
