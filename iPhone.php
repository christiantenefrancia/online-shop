...
<hr>
    ...
    <h2>&emsp;&emsp;List of Our Products</h2>
   <div style="padding-left: 30px; padding-right: 148px;">
        <div class="blue ui five item menu">
          <a class="item active" href="iPhone.php" id="iPhone">iPhone</a>
          <a class="item" href="lenovo.php" id="lenovo">Lenovo</a>
    ...
    <ul class="thumbnails" style="padding-left: 8%;">
        <?php
        $query = mysql_query("select * from tb_products WHERE category = 'iPhone'") or die(mysql_error());
