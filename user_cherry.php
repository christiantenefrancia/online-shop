        ...
        <hr>
                    ...
                    <div style="padding-left: 30px; padding-right: 148px;">
                            <div class="blue ui five item menu">
                              ...
                              <a class="item" href="user_samsung.php" id="samsung">Samsung</a>
                              <a class="item active" href="user_cherry.php" id="cherry">Cherry Mobile</a>
                            </div>
                        </div>
                        <ul class="thumbnails" style="padding-left: 8%;">
                            <?php
                            $query = mysql_query("select * from tb_products WHERE category = 'cherryMobile'") or die(mysql_error());
                                       ...
                                       <h4 class="ui block header">
                                        ...
                                        <a  href="#<?php echo $id; ?>"   data-toggle="modal">
                                            <img src="admin/<?php echo $row['location'] ?>" 
                                                 class="img-rounded" alt="" width="160" height="200">                                        
                                        </a>
                                    ...
                                    if (isset($_POST['order'])) 
                                    {
										...
										?>
												<script>
												    ...
												    window.location = 'user_cherry.php';				
								                </script>
										<?php
                                    }
                                    ?>
