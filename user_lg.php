        ...
        <hr>
                        ...
                        <div style="padding-left: 30px; padding-right: 148px;">
                            <div class="blue ui five item menu">
                              ...
                              <a class="item active" href="user_lg.php" id="lg">LG</a>
                        ...
                        <ul class="thumbnails" style="padding-left: 8%;">
                            <?php
                            $query = mysql_query("select * from tb_products WHERE category = 'lg'") or die(mysql_error());
